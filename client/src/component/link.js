        ...
        <>
          <div className='linkMain'>
             <div className="link">
                 ...
                 <div className="linkDiv"><h4 className="votelink">{`localhost:3000/vote/${props.value}`}</h4></div>
                 <div className="line"></div>
                 <h4>The admin link to manage your poll is</h4>
                 <h5>Don't share this link with your participants</h5>
                 <div className="adminLinkDiv"><h4 className="votelink">{`localhost:3000/result/${props.value}`}</h4></div>
